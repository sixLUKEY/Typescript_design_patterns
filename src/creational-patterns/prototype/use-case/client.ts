...
//! This also modifies ORIGINAL_DOCUMENT because of the shallow copy using mode 1
...
//* This does NOT modify ORIGINAL_DOCUMENT because it changes the complete array[1] reference which was a shallow copy
...
//! This DOES modify ORIGINAL_DOCUMENT because it changes the element of array[1][0] that was deep copied recursively using mode 2
